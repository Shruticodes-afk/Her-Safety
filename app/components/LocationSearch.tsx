...
export default function LocationSearch({ onLocationSelect, isOverlay = true }: LocationSearchProps) {
  ...
  const containerClasses = isOverlay 
    ? "absolute top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-[1000]"
    : "relative w-full mb-4 z-[1000]"

  const dropdownClasses = isOverlay
    ? "mt-2 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto"
    : "absolute left-0 right-0 mt-2 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto z-[1001]"
